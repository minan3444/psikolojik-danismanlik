...
export default function BasariEkrani({ secimler }) {
  ...
  return (
    <Box sx={{ textAlign: 'center', py: 4 }}>
      <Typography
        variant="h4"
        sx={{ fontFamily: 'var(--font-playfair)', fontWeight: 700, color: 'primary.main', mb: 2 }}
      >
        Talebiniz Alındı 🌿
      </Typography>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
        ...
        <b> {hizmet?.baslik}</b> talebiniz iletildi.
      ...
      <Box sx={{ display: 'flex', gap: 2, justifyContent: 'center', flexWrap: 'wrap' }}>
        <Button
          ...
          target="_blank"
          sx={{ borderRadius: '50px', bgcolor: '#25D366', px: 3, py: 1.2, fontWeight: 700 }}
        >
