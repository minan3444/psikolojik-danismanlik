...
// import { Box, Container, Grid, Typography, Button, Chip, Breadcrumbs } from "@mui/material";
...
//               >
//                 {/* Test Rengi Şeridi */}
//                 <Box sx={{ height: 6, backgroundColor: test.renk || 'primary.main' }} />

//                 <Box sx={{ p: 4, display: "flex", flexDirection: "column", flexGrow: 1 }}>
//                   <Typography variant="h5" sx={{ fontFamily: "var(--font-playfair)", fontWeight: 700, mb: 2 }}>
//                     {test.baslik}
//                   </Typography>

//                   <Typography variant="body2" color="text.secondary" sx={{ mb: 3, flexGrow: 1, lineHeight: 1.8 }}>
//                     {test.aciklama}
//                   </Typography>
